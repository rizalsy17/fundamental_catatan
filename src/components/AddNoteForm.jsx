...
import { faSignOutAlt, faAdjust, faLanguage } from '@fortawesome/free-solid-svg-icons';
...
const AddNoteForm = ({ onAddNote }) => {
  ...
  return (
    ...
    <div className="add-note-form-container" style={{ backgroundColor: theme === 'light' ? '#ffffff' : '#222222' }}>
        ...
        <form>
          ...
          <label htmlFor="noteContent">{language === 'id' ? 'Isi Catatan' : 'Fill Note'}</label>
          <textarea
            id="body"
            name="body"
            value={newNote.body}
